...
OBJS := $(obj).target/$(TARGET)/third_party/jsmin/jsmin.o
...
$(builddir)/jsmin_bin: GYP_LDFLAGS := $(LDFLAGS_$(BUILDTYPE))
$(builddir)/jsmin_bin: LIBS := $(LIBS)
$(builddir)/jsmin_bin: TOOLSET := $(TOOLSET)
$(builddir)/jsmin_bin: $(OBJS) FORCE_DO_CMD
	$(call do_cmd,link)

all_deps += $(builddir)/jsmin_bin
# Add target alias
.PHONY: jsmin_bin
jsmin_bin: $(builddir)/jsmin_bin

# Add executable to "all" target.
.PHONY: all
all: $(builddir)/jsmin_bin
